...
@media(max-width:1300px){html,body{overflow:auto;height:auto}.app{height:auto;min-height:100vh;overflow:visible}.topbar{grid-template-columns:1fr}.marketStrip{grid-template-columns:repeat(2,1fr)}.toolbar{grid-template-columns:1fr}.grid{grid-template-columns:1fr}.rightMain{grid-template-rows:auto 500px auto}.bottomCards{grid-template-columns:1fr 1fr}.left{grid-template-rows:auto}.error{position:static}.foot{height:auto;min-height:34px}}@media(max-width:700px){.bottomCards,.kpiStrip,.marketStrip{grid-template-columns:1fr}.tfTabs{min-width:0;width:100%;overflow:auto}.brand h1{font-size:16px}}
</style>
</head>
<body>
<div class="app">
...
let layout=d.chart.layout||{};layout.paper_bgcolor='rgba(0,0,0,0)';layout.plot_bgcolor='#081523';layout.font={color:'#cbd5e1',size:10};layout.margin={l:56,r:68,t:18,b:58};layout.height=null;layout.autosize=true;layout.legend={orientation:'h',y:1.08,x:0,font:{size:10,color:'#cbd5e1'}};layout.xaxis={...(layout.xaxis||{}),gridcolor:'rgba(148,163,184,.12)',linecolor:'#203047',fixedrange:true,rangebreaks:['1M','15M','30M','1H'].includes(d.tf)?[{bounds:['sat','mon']}]:[]};layout.yaxis={...(layout.yaxis||{}),gridcolor:'rgba(148,163,184,.12)',linecolor:'#203047',fixedrange:true};
